...
const initializeProductionDatabase = async () => {
  try {
    ...
    // Create sample data
    await createProductionSampleData();
...
const createProductionSampleData = async () => {
  try {
    console.log('Creating production sample data...');
    ...
    console.log('Production sample data created successfully!');
  } catch (error) {
    console.error('Error creating production sample data:', error);
    throw error;
  }
};
